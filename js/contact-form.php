...
$e_subject = 'Formularz tacan-energy.pl';

// Configuration option.
// You can change this if you feel that you need to.
// Developers, you may wish to add more fields to the form, in which case you must be sure to add them here.

$e_body = "Prośba o kontakt ze strony internetowej: <br>" . PHP_EOL . PHP_EOL;
$e_content = "<br>" . PHP_EOL . PHP_EOL;
$e_reply = "Imię i nazwisko: $name $ndname <br> Mail: $email".PHP_EOL." <br> telefon: $phone <br> Zgoda: <br> $rodo";
