<?php /* Template name: Dla biznesu */ ?>
<?php get_header(); ?>

<section id="business" class="section">
	<div class="container">
		<div class="row">
			<div class="col-md-6 animated slide-left align-self-center">
				<img src="<?php echo THEME_URL; ?>img/biznes.jpg" alt="" class="img-fluid">
			</div>
			<div class="col-md-6 align-self-center animated slide-right">
				<h2 class="title">Fotowoltaika <span class="yellow">dla firm</span></h2>
				<p class="sub-p maven">Chcesz uniezależnić się od wzrostu cen prądu? <br>Postaw na własną elektrownię.</p>
				<ul class="own">
					<li>Zacznij zarabiać i oszczędzać</li>
					<li>Korzystna oferta leasingu</li>
					<li>Gwarancja działania 25 lat</li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-9">
				<div class="row relative">
					...
					<div class="col-md-4 hicon animated slide-left">
						...
						<h3>Współpracując z nami <br><strong>zwrot w 8 lat</strong></h3>
					</div>
					...
					<div class="col-md-4 hicon animated slide-right">
						...
						<h3><strong>17 lat</strong><br>prądu za darmo</h3>
					</div>
				</div>
			</div>
		</div>
